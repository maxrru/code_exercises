...
/**
 *Hier steht der Javascript-Teil zu Aufgabe 9: User-Counter und User-Tracker
 */
...
function callSession(){
    ...
    xmlhttp.onreadystatechange = function () {
        if (xmlhttp.readyState === 4 && xmlhttp.status === 200){
            var usrCount = xmlhttp.responseText;
            //console.log(usrCount);
            document.getElementById("usrcount").innerHTML = usrCount;
        }
    };
    
    xmlhttp.open("GET", "http://localhost/WebApp_Uebung_09/counter.php");
    xmlhttp.send();
